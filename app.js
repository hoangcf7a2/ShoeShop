...
app.use((req,res,next)=>{
    res.setHeader('Access-Control-Allow-Origin',process.env.ALLOW_HOST_ORIGIN); // cho phép tất cả các trang web thứ 3 dùng api của mình , * cho phép tất cả gọi vào, nhưng sẽ k nhận được credential vd như cookie
